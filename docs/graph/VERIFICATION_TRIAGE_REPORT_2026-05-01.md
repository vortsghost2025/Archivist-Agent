...
**Generated**: 2026-05-01T04:04:14.313Z  
**Analyzed by**: SwarmMind (dry-run)  
**Snapshot**: snapshot-2026-04-30-10-25-58
...
| Metric | Count |
|---|---|
| Unverified nodes with authorityDepth ≥ 70 | **1198** |
| Likely structural (low verification priority) | **481** |
| Governance/docs (high verification priority) | **116** |
| Ambiguous (manual review needed) | **601** |
...
| self-organizing-library | 386 | 127 | 25 | 234 |
| Archivist-Agent | 368 | 168 | 47 | 153 |
| SwarmMind-Self-Optimizing-Multi-Agent-AI-System | 220 | 120 | 14 | 86 |
| kernel-lane | 186 | 61 | 17 | 108 |
| papers | 38 | 5 | 13 | 20 |
...
- 0479dcb3fbb0833f: targets.json (self-organizing-library) authorityDepth:90
